...
#                             POST   /:locale/channels/:channel_id/book_assignments(.:format)                                   mail/book_assignments#create {:subdomain=>"", :locale=>/ja|en/}
# new_channel_book_assignment GET    /:locale/channels/:channel_id/book_assignments/new(.:format)                               mail/book_assignments#new {:subdomain=>"", :locale=>/ja|en/}
...
#            book_assignments POST   /:locale/book_assignments(.:format)                                                        mail/book_assignments#create {:subdomain=>"", :locale=>/ja|en/}
  ...
  constraints subdomain: '' do
    scope module: :mail do
      scope ":locale", locale: /ja|en/ do
        ...
        resources :book_assignments, only: [:new, :create]
