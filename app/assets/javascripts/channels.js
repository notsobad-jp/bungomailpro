...
function addBook(data) {
  ...
  item.innerHTML = `
    ...
    <div class="content">
      ...
      <div class="extra">
        <small>全${ data['chapters_count'] }回配信</small>
        <input value="${ data['id'] }" type="hidden" name="channel[channel_books_attributes][${ index }][book_id]">
        <input id="${ data['id'] }_index" value="${ index + 1 }" type="hidden" name="channel[channel_books_attributes][${ index }][index]">
        <input id="${ data['id'] }_destroy" value="false" type="hidden" name="channel[channel_books_attributes][${ index }][_destroy]">
        <input value="" type="hidden" name="channel[channel_books_attributes][${ index }][id]">
      </div>
    </div>
  `;
